...
[![Go Reference](https://pkg.go.dev/badge/github.com/pytomtoto/gocui.svg)](https://pkg.go.dev/github.com/pytomtoto/gocui)
...
```
$ go get github.com/pytomtoto/gocui
```
...
```
$ go doc github.com/pytomtoto/gocui
```

Or visit [pkg.go.dev](https://pkg.go.dev/github.com/pytomtoto/gocui) to read
it online.
